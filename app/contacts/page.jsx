    ...
    <div className='relative bg-white bg-opacity-85 w-full max-w-screen h-screen'>
        <div className='relative bg-main h-full w-full transform rotate-30 rounded-bl-[35%] rounded-tr-[35%]'>
            <div className='flex justify-center items-center '>
                ...
                <Logo/>
                <div>
                    <h1 className='text-base text-white font-bold text-center mt-8'>Contacts</h1>
                    <button className='mt-4 px-5 py-2 rounded-full text-base bg-transparent border-2  bg-blue-500 text-white'>Add Contact</button>
                </div>
                <div className='container mx-auto text-base bg-white rounded-md'>
                    <Table/>
                </div>
                </div>
            </div>
